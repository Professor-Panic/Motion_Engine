            ...
            if(obj["type"]=="Text"){
                ...
                for(int i=0;i<obj["Keyframes"].size();i++){
                    ...
                    if(Keyframes.contains("Fontsize")){
                        if(Keyframes["Fontsize"].contains("Values")){
                            currentTransform.trans_scale.scale={Keyframes["Fontsize"]["Values"],0};
                        }
                        if(Keyframes["Fontsize"].contains("Interpolation")){
                            currentTransform.trans_scale.interPolation=Keyframes["Fontsize"]["Interpolation"];
                        }
                        else{
                            currentTransform.trans_scale.interPolation=0;   
                        }
                    ...
                    text.transforms.push_back(currentTransform);
                    text.textPath=path;
